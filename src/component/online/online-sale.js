...
const OnlineSale = () => {
    ...
    const radios = [
        ...
        { name: 'Preparing for dispatch', value: 'Preparing for dispatch' ,variant:'warning'},
    ...
    useEffect(() => {
        ...
        async function fetchData(){
            ...
            await  fetch(URL + "/APP-API/Billing/getOnlineOrder", {
                  method: 'post',
                  header: {
                  ...
                  .then((responseJson) => {
                     ...
                     console.log("order onlne",responseJson)
                      setShowData(responseJson.online_order);
    ...
    const STORY_HEADERS = [
   ...
   
        {
            ...
            cell: (row) => {
                return (
                    <p className="text-success">{row.customer_name}</p>
                );
            }
        },
        {
            ...
            cell: (row) => {
                return (
                    <p className="text-dark">{row.customer_address}</p>
                );
            }
        },
        {
            ...
            cell: (row) => {
                return (
                    <p className="text-primary">{row.customer_phone}</p>
                );
            }
        },
     ...
     
        {
            ...
            cell: (row) => {
                return (
                    <p className="text-danger"> ₹ {row.total_payment}</p>
                );
            }
        },
       
        {
            ...
            cell: (row) => {
                return (
                    <p className="text-dark">{row.payment_mode}</p>
                );
            }
        },
    
        {
            ...
            cell: (row) => {
                return (
                    <p className="text-dark">{row.date} {row.time}</p>
                );
            }
        },
            ...
            cell: (row) => {
                ...
                return (
                    <Dropdown>
                        ...
                        <Dropdown.Item className="btn btn-primary" onClick={() => navigate("/online/online-sales-history-record/" + row.order_id + "/" + row.customer_address_id)}>View Record</Dropdown.Item>
