                                                            ...
                                                            return (
                                                                <>
                                                                    {items && < tr >
                                                                        ...
                                                                        <td><BiRupee /> {items.s_gst}</td>
                                                                        <td><BiRupee /> {items.c_gst}</td>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6 col-print-6 px-0 py-3" style={{ borderLeft: "1px solid #d9d9d9" }}>
                                                ...
                                                <div className="d-flex py-3 px-5 justify-content-between align-items-center border-bottom">
                                                    ...
                                                    <h5 style={{ fontSize: 16, margin: 0, fontWeight: "700", color: "black" }}><BiRupee /> {store_vendor_purchase_record_data.total_payment}</h5>
                                                </div>
