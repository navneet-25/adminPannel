...
const ProductManagement = () => {
  ...
  async function fetchData() {
    const data = await fetch(
      URLDomain + "/APP-API/Billing/storeProductsDataApi",
      {
        method: "post",
        header: {
              ...
              <div className="col-sm-auto ms-auto">
                <div className="list-grid-nav hstack gap-1">
                  ...
                  <button
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#addUnits"
                  >
                    <i className="ri-add-fill me-1 align-bottom" /> Add Units
                  </button>
                  <button
                  ...
                  >
                    <i className="ri-add-fill me-1 align-bottom" /> Add Products
                  </button>
                </div>
              </div>
              {/*end col*/}
                ...
                <div className="card-body">
                  <div id="customerList">
                    <div className="table-responsive table-card mb-1">
                      <DatatableWrapper
                        body={showData}
                        // initialSort={{ prop: "id", isAscending: false }}
