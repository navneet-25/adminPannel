!function () {
    ...
    sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-layout-mode"] = sessionStorage.getItem("data-layout-mode"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), B(a)) : (e = document.documentElement.attributes, a = {},
        ...
        (e = document.querySelectorAll(".light-dark-mode")) && e.length && e[0].addEventListener("click", function (e) {
        ...
        I(),
        f(),
        document.getElementsByClassName("dropdown-item-cart") && (d = document.querySelectorAll(".dropdown-item-cart").length, document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn").forEach(function (e) {
            ...
            e.innerHTML = d
        }), document.getElementById("empty-cart").style.display = "none", document.getElementById("checkout-elem").style.display = "block", q()),
    ...
    function u(e) {
        ...
        document.querySelectorAll(".navbar-nav .collapse") && document.querySelectorAll(".navbar-nav .collapse").forEach(function (t) {
            ...
            t.addEventListener("show.bs.collapse", function (e) {
                ...
                e ? e.querySelectorAll(".collapse").forEach(function (e) {
                    ...
                    for (var t = [], a = e.parentNode.firstChild;
                        a;) 1 === a.nodeType && a !== e && t.push(a),
                            a = a.nextSibling;
                    return t
        ...
        if (e) {
            ...
            if (e.offsetParent)
                for (;
                    e.offsetParent;) t += (e = e.offsetParent).offsetTop,
                        a += e.offsetLeft;
        ...
        "vertical" == document.documentElement.getAttribute("data-layout") && (document.getElementById("two-column-menu").innerHTML = "", document.querySelector(".navbar-menu").innerHTML = i, document.getElementById("scrollbar").setAttribute("data-simplebar", ""), document.getElementById("navbar-nav").setAttribute("data-simplebar", ""), document.getElementById("scrollbar").classList.add("h-100")),
        ...
        if (e.target && e.target.matches("a.nav-link span"))
            if (0 == y(e.target.parentElement.nextElementSibling)) e.target.parentElement.nextElementSibling.classList.add("dropdown-custom-right"),
                ...
                if (1 == y(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth)
                    for (var t = document.getElementsByClassName("dropdown-custom-right");
                        0 < t.length;) t[0].classList.remove("dropdown-custom-right");
        if (e.target && e.target.matches("a.nav-link"))
            if (0 == y(e.target.nextElementSibling)) e.target.nextElementSibling.classList.add("dropdown-custom-right"),
                ...
                if (1 == y(e.target.nextElementSibling) && 1848 <= window.innerWidth)
                    for (t = document.getElementsByClassName("dropdown-custom-right");
                        0 < t.length;) t[0].classList.remove("dropdown-custom-right")
    } function E() {
        var e = document.documentElement.clientWidth;
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            window.addEventListener("load", function () {
                ...
                ("twocolumn" == document.documentElement.getAttribute("data-layout") ? w : S)(),
                    (e = document.getElementsByClassName("vertical-overlay")) && e.forEach(function (e) {
            ...
            a == e.value ? e.checked = !0 : e.checked = !1,
                e.addEventListener("change", function () {
                    document.documentElement.setAttribute(t, e.value),
                        ...
                        "data-layout" == t && ("vertical" == e.value ? (A("vertical"), g(), feather.replace()) : "horizontal" == e.value ? (A("horizontal"), feather.replace()) : "twocolumn" == e.value && (A("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), b(), w(), g(), feather.replace()))
                })
        })
    } function x(e, t, a, o) {
